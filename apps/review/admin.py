...
class ReviewAdmin(admin.ModelAdmin):
    ...
    def review_type(self, obj):
        ...
        if obj.is_positive_review():
            return format_html('<span style="color: green; font-weight: bold;">Positiva</span>')
        elif obj.is_negative_review():
            return format_html('<span style="color: red; font-weight: bold;">Negativa</span>')
        else:
            return format_html('<span style="color: orange; font-weight: bold;">Neutra</span>')
    ...
    def mark_as_featured(self, request, queryset):
        ...
        self.message_user(request, f"{queryset.count()} avaliações marcadas como destaque.")
