...
# Redis Cache Configuration (All Environments)
CACHES = {
    "default": {
        ...
        "OPTIONS": {
            ...
            "IGNORE_EXCEPTIONS": False,  # Falha rápida se Redis não estiver disponível
    ...
    "throttle": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": env("REDIS_THROTTLE_URL", default="redis://127.0.0.1:6379/1"),
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        ...
        "KEY_PREFIX": env("REDIS_THROTTLE_KEY_PREFIX", default="barbershop_throttle"),
        "VERSION": 1,
    },
}
